 ...
 * 
 * Reads in text files specified as the first command-line parameters,
 * concatenates them, and writes the result to filename specified as the last
