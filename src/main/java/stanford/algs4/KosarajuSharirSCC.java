 ...
 * Runs in O(E + V) time.
 * 
 * % java KosarajuSCC tinyDG.txt 5 components 1 0 2 3 4 5 9 10 11 12 6 7 8
 * 
 * % java KosarajuSharirSCC mediumDG.txt 10 components 21 2 5 6 8 9 11 12 13 15
 * 16 18 19 22 23 25 26 28 29 30 31 32 33 34 35 37 38 39 40 42 43 44 46 47 48 49
 * 14 3 4 17 20 24 27 36 41 7 45 1 0 10
 * 
 *************************************************************************/
