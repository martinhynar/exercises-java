 ...
 * 
 * Reads in a set of key-value pairs from a two-column CSV file specified on the
 * command line; then, reads in keys from standard input and prints out
 * corresponding values.
 * 
 * % java LookupCSV amino.csv 0 3 % java LookupCSV ip.csv 0 1 TTA www.google.com
 * Leucine 216.239.41.99 ABC Not found % java LookupCSV ip.csv 1 0 TCT
 * 216.239.41.99 Serine www.google.com
 * 
 * % java LookupCSV amino.csv 3 0 % java LookupCSV DJIA.csv 0 1 Glycine
 * 29-Oct-29 GGG 252.38 20-Oct-87 1738.74
 * 
 * 
 *************************************************************************/
