...
import stanford.stdlib.BinaryStdIn;
import stanford.stdlib.BinaryStdOut;
 ...
 * 
 * Compress or expand binary input from standard input using run-length
 * encoding.
 * 
 * % java BinaryDump 40 < 4runs.bin 0000000000000001111111000000011111111111 40
 * bits
 * 
