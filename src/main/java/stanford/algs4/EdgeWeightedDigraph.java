...
/**
 * The <tt>EdgeWeightedDigraph</tt> class represents an directed graph of
 * vertices named 0 through V-1, where each edge has a real-valued weight. It
 * supports the following operations: add an edge to the graph, iterate over all
 * of edges leaving a vertex. Parallel edges and self-loops are permitted.
 * <p>
...
public class EdgeWeightedDigraph {
    ...
    /**
     * Return the edges incident from vertex v as an Iterable. To iterate over
     * the edges incident from vertex v in digraph G, use foreach notation:
    ...
    /**
     * Return all edges in this digraph as an Iterable. To iterate over the
     * edges in the digraph, use foreach notation:
