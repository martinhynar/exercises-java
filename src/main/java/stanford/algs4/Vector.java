...
/*************************************************************************
 * Compilation: javac Vector.java Execution: java Vector
 * 
 ...
 * 
 * % java Vector x = [ 1.0 2.0 3.0 4.0 ] y = [ 5.0 2.0 4.0 1.0 ] z = [ 6.0 4.0
 * 7.0 5.0 ] 10z = [ 60.0 40.0 70.0 50.0 ] |x| = 5.477225575051661 <x, y> = 25.0
 * 
 * 
