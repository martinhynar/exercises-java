...
public final class Draw implements ActionListener, MouseListener,
    ...
    /**
     * Shade of blue used in Introduction to Programming in Java. The RGB values
     * are (9, 90, 166).
     */
    ...
    /**
     * Set the upper-left hand corner of the drawing window to be (x, y), where
     * (0, 0) is upper left.
     * 
     * @param x
